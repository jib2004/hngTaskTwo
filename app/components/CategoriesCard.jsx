...
const CategoriesCard = ({imgSrc,  categoryName}) => {
  return (
    <div className="flex flex-col justify-between items-center w-[150px] md:w-[205px] h-[175px] md:h-[232px] border border-[#c1c1c1] rounded-[8px] md:rounded-[16px] py-2 md:py-[24px] md:px-[31px] md:border-[2px]">
