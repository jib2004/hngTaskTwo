...
const SummerAd = () => {
  return (
    <div className='h-[270px] md:h-[507px] border bg-[#006200] opacity-60 relative flex flex-col justify-between p-[16px] md:rounded-[24px] md:w-[90%] md:mx-auto mb-[24px]'>
        ...
        <p className='w-[351px] xl:w[623px] tracking-[4%] leading-[21px] md:leading-[40px] text-[14px] md:text-[24px] text-white'>
